...
\begin{itemize}
\item $\mathtt{Q}^-\ket{1}=\ket{0}$ et $\mathtt{Q}^-\ket{0}=0$ signifie que $\mathtt{Q}^-=\kb{0}{1}=\frac12(\mathtt{X} + i\mathtt{Y}) $ ;

\item  $\mathtt{Q}^+\ket{0}=\ket{1}$ et $\mathtt{Q}^+\ket{1}=0$ signifie que $\mathtt{Q}^+=\kb{1}{0}=\frac12(\mathtt{X} - i\mathtt{Y}) $ .
\end{itemize}
\end{remarque}
