...
La fonction d'onde dans cette méthode est représentée par un déterminant de Slater, qui impose l'antisymétrie requise pour les électrons, particules de spin-$\frac12$. Il est défini comme suit :
```{=tex}
\begin{equation}
...
\begin{figure}[tbph]
\centering
\includegraphics[width=0.7\linewidth]{SCF_Workflow.pdf}
