...
Voici un encadré en TikZ résumant les concepts de cette section.
...
% Title
\node[title] at (box.north) [yshift=0.7cm] {Résumé des méthodes d'état fondamental};
...
Les méthodes pour l’état fondamental offrent une hiérarchie de précisions et de coûts computationnels, permettant aux chercheurs de choisir l’approche la plus adaptée selon leurs besoins. Si vous souhaitez approfondir l'un des concepts ou des diagrammes spécifiques, faites-le-moi savoir !
